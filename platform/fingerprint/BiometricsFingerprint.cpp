 ...
 */
#define LOG_TAG "android.hardware.biometrics.fingerprint@2.3-service.xiaomi_mona"
#define LOG_VERBOSE "android.hardware.biometrics.fingerprint@2.3-service.xiaomi_mona"
...
void BiometricsFingerprint::setFodStatus(int value) {
